...
export const info: Info[] = [
	...
	},
	{
		...
		items:[
			...
			{
				item:'Otras:',
				content:'Vue.js, Next.js, Mongo DB, PostgrSQL, Sass, Node.js, Java SE, MySQL.',
			},
			{
	...
	},
	{
		...
		items:[
			...
			{
				item:'2014-2017',
				content:'Instituto profesional DUOC UC - Ingeniero en mecánica automotriz.',
			},
		],
	},
	{
		...
		items:[
			...
			{
				item:'',
				content:'Dentro de mis deberes están el desarrollar junto con un equipo de trabajo, un aplicativo web para un cliente, utilizando React.js, Typescript y Redux toolkit. Para ello se crea cada una de las nuevas características con sus respectivos test usando Jest.js',
			},
			{
			...
			{
				item:'',
				content:'Dentro de mis funciones estaban: Desarrollar productos nuevos con Vue.js, resolver diferentes features con Java o React Native, también trabajé con bases de datos PostgreSQL, además de ocupar AWS para el servicio en la nube.',
			},
			{
			...
			{
				item:'',
				content:'El trabajo consistía en el desarrollo de una página web con React.js para la empresa junto a un equipo de personas.',
			},
		],
	},
	{
